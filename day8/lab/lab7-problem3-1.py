...
for i in range(11):
    initial_theta_polynomial = np.ones((X_train_polynomial_normalized.shape[1], 1))  # Put your code here

    cost_train, cost_cv = learningCurve(initial_theta_polynomial,
                                        X_train_polynomial_normalized, y_train,
                                        X_cv_polynomial_normalized, y_cv, i)  # Put your code here
