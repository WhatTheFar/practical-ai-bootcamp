...
hypothesis_function = tf.divide(1.0, 1.0 + tf.exp(-(z + theta0)))
...
with tf.Session() as session:
    ...
    print("theta0: {0}, theta1: {1}, theta2: {2}".format(session.run(theta0[0]), session.run(thetas[0][0]),
                                                         session.run(thetas[1][0])))
